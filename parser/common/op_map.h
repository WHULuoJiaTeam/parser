...
/*lint -e1073*/
namespace ge {
// the operator type mapping table of caffe and  luojianet
extern std::map<std::string, std::string> caffe_op_map;

// the operator type mapping table of TensorFlow and  luojianet
extern std::map<std::string, std::string> tensorflow_op_map;

// the network training operator type mapping table of TensorFlow and  luojianet
